<template>
    <div class="form">
        <form class="p-4">
            <h1 class="p-2 fs-3 fw-bold">Login</h1>
            <div class="pt-3 row m-0">
                <label class="fs-6 d-flex align-items-center col-md-3 col-sm-4 m-0 p-0 col-form-label">Email:</label>
                 <div class="col-md-9 col-sm-8 m-0 p-0">
                    <input class="form-control shadow-none" type="email" />
                </div>
            </div>
            <div class="pt-3 row m-0">
                <label class="fs-6 d-flex align-items-center col-md-3 col-sm-4 m-0 p-0 col-form-label">Password:</label>
                 <div class="col-md-9 col-sm-8 m-0 p-0">
            ...
            <div class="row justify-content-center">
                <div class="col justify-content-center d-flex">
                    <a class="btn btn-outline-dark" :href="$config.public.backendHost + '/login-google'" role="button" style="text-transform:none">
                        <img width="20px" style="margin-bottom:3px; margin-right:5px" alt="Google sign-in"
                            src="../assets/images/google.png" />
                        Signin with with Google
                    </a>
                </div>
            </div>
        </form>
